...
import bda.studio.client.OozieConnectionFactory;
...
import bda.studio.client.ui.panel.Grid.SearchGrid;
...
import bda.studio.client.ui.tree.*;
import bda.studio.client.ui.widget.DisclosureStackPanel;
...
public class MonitorView extends Generator implements MonitorPresenter.View {
  ...
  private Button suspendBtn = new Button("Suspend");
  private Button resumeBtn = new Button("Restart");
