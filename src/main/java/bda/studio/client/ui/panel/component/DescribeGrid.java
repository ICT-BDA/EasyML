 ...
 */
package bda.studio.client.ui.panel.component;
...
import bda.studio.client.ui.panel.component.DescCmdPanel;
import bda.studio.client.ui.panel.component.DescListBox;
import bda.studio.client.ui.panel.component.DescTextArea;
import bda.studio.client.ui.panel.component.DescTextBox;
import bda.studio.client.ui.panel.component.DescWidget;
...
/*  public Program asProgram(){
    ...
    program.setName(this.getText("Name".toLowerCase()));
    program.setCategory(this.getText("Category".toLowerCase()));
    program.setType(this.getText("Type".toLowerCase()));
    //program.setIsdeterministic( Boolean.parseBoolean( this.getText("Deterministic".toLowerCase())) );
    if("是".equals(this.getText("Isdeterministic".toLowerCase())))
      program.setIsdeterministic(true);
    else
      program.setIsdeterministic(false);
    program.setDescription(this.getText("Description".toLowerCase()));
    program.setVersion(this.getText("Version".toLowerCase()));
    program.setCreatedate(this.getText("CreateDate".toLowerCase()));
    program.setOwner(this.getText("Owner".toLowerCase()));
    program.setCommandline(this.getText("CommandLine".toLowerCase()));
  ...
  /*public Dataset asDataset(){
    ...
    dataset.setStoretype(this.getText("DataType".toLowerCase()));
