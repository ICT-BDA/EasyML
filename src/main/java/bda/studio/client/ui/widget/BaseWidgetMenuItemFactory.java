 ...
 */
package bda.studio.client.ui.widget;

import bda.studio.client.controller.DiagramController;
import bda.studio.client.controller.MonitorController;
import bda.studio.client.ui.menu.HasRightMouseUpMenu;
import bda.studio.client.ui.menu.MenuItemCommand;
...
public class BaseWidgetMenuItemFactory {
  ...
  public static MenuItem createDownloadData(HasRightMouseUpMenu com) {
    Command command = new MenuItemCommand(com) {
      ...
      public void execute() {
        ...
        String url = GWT.getModuleBaseURL().split("BDAStudio")[0]
            + "BDAStudioMonitor/filedownload?filename=" + filename;
  ...
  public static MenuItem createStderrItem(HasRightMouseUpMenu com) {
    ...
    MenuItem item = new MenuItem("Show Std Error", command);
    return item;
  }
    /**
     * Create StdoutItem
  ...
  public static MenuItem createStdoutItem(HasRightMouseUpMenu com) {
    ...
    MenuItem item = new MenuItem("Show std out", command);
    return item;
  }
}
