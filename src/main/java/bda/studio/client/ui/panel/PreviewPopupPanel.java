...
import bda.studio.client.ui.tree.PopupRetDirLeaf;
import bda.studio.client.ui.tree.PopupRetDirTree;
import bda.studio.client.ui.tree.PopupRetDirTreeLoad;
					...
					public void onSuccess(Double size) {
						...
						if(size<MAX_DOWNLOAD_SIZE )
						{
							...
							String url = GWT.getModuleBaseURL().split("BDAStudio")[0]
									+ "BDAStudioMonitor/filedownload?filename=" + sourceUrl;
