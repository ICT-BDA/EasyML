...
public class FileUploader extends VerticalPanel {
	...
	public void init() {
				...
				// .setButtonWindowMode(Uploader.WindowMode.TRANSPARENT)
		...
		if (Uploader.isAjaxUploadWithProgressEventsSupported()) {
			...
			// final Label dropFilesLabel = new Label("拖动到此区域");
			dropFilesLabel.getElement().getStyle().setCursor(Cursor.POINTER);
			dropFilesLabel.setSize("32px", "32px");
			dropFilesLabel.setTitle("可拖动文件上传区域");
			// dropFilesLabel.setVisible(null, true);
