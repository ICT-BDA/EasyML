...
import bda.studio.client.ui.widget.command.Commander;
import bda.studio.client.ui.widget.command.FileDescription;
import bda.studio.client.ui.widget.command.FileHolder;
import bda.studio.client.ui.widget.command.Parameter;

/**
 * Conf of CommonProgram
 */
public class CommonProgramConf implements ProgramConf{

	private Commander commander = null;
	private boolean standalone;
	public CommonProgramConf(Commander cmd, boolean standalone){
		commander = cmd;
