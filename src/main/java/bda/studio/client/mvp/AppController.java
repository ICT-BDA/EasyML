 ...
 */
package bda.studio.client.mvp;

import java.util.Random;
import java.util.logging.Logger;

import bda.studio.client.controller.LoginController;
import bda.studio.client.event.LoginEvent;
import bda.studio.client.event.LogoutEvent;
import bda.studio.client.event.ToMonitorEvent;
import bda.studio.client.mvp.presenter.AccountPresenter;
import bda.studio.client.mvp.presenter.AdminPresenter;
import bda.studio.client.mvp.presenter.MonitorPresenter;
import bda.studio.client.mvp.presenter.Presenter;
import bda.studio.client.mvp.presenter.RegisterPresenter;
import bda.studio.client.mvp.presenter.ResetpwdPresenter;
import bda.studio.client.mvp.view.AccountView;
import bda.studio.client.mvp.view.AdminView;
import bda.studio.client.mvp.view.MonitorView;
import bda.studio.client.mvp.view.RegisterView;
import bda.studio.client.mvp.view.ResetpwdView;
