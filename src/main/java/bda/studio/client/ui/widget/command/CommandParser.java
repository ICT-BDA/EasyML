 ...
 */
package bda.studio.client.ui.widget.command;

import bda.studio.client.ui.widget.command.FileDescription.StoreType;
import bda.studio.client.ui.widget.command.FileHolder.FileType;
...
public class CommandParser {
	...
	public static int extractFileHolder(char[] arr, int offset,FileHolder holder) throws CommandParseException{
		...
		if( word.equals( "in") ){
			holder.setFileType( FileType.InputFile);
			offset = k;
			...
			holder.setFileType( FileType.OutputFile);
			offset = k;
			//The next colon offset
		...
		holder.setStoreType( StoreType.get(storeType) );
